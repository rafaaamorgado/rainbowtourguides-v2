...
export default async function GuidePage({ params }: GuidePageProps) {
  ...
  const hourlyRate = guideWithRelations.hourly_rate
    ? parseFloat(guideWithRelations.hourly_rate)
    : 50;
  const currency = guideWithRelations.currency || 'USD';

  // Get public URL for avatar image
  const avatarUrl = await getStoragePublicUrlServer(
  ...
  async function createBooking(
    ...
    const guideName =
      (guideProfile as { display_name: string } | null)?.display_name ||
      'the guide';
                ...
                <div className="flex flex-wrap items-center gap-4 text-white/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium">
                      ...
                      {guideWithRelations.city.country_name &&
                        `, ${guideWithRelations.city.country_name}`}
                    </span>
                  </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              {guideWithRelations.languages &&
                guideWithRelations.languages.length > 0 && (
                  <Card>
                    <CardContent className="p-6 text-center">
                      <div className="flex justify-center mb-3">
                        <div className="w-12 h-12 bg-brand/10 rounded-2xl flex items-center justify-center">
              ...
              {guideWithRelations.themes &&
                guideWithRelations.themes.length > 0 && (
                  <Card>
                    <CardContent className="p-6 text-center">
                      <div className="flex justify-center mb-3">
                        <div className="w-12 h-12 bg-brand/10 rounded-2xl flex items-center justify-center">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-slate-500 mt-6 text-center">
                  Custom durations available. Use the booking form to request
                  your preferred time.
                </p>
              </CardContent>
            </Card>
                  ...
                  <div className="max-w-md mx-auto space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-slate-600 font-light leading-relaxed">
                        Use the booking form to see{' '}
                        {guideWithRelations.profile.display_name}&apos;s
                        available dates and times. Select your preferred date to
                        get started.
                      </p>
                    </div>
                  ...
                  <div className="max-w-md mx-auto space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-slate-600 font-light leading-relaxed">
                        Be the first to book an experience with{' '}
                        {guideWithRelations.profile.display_name} and leave a
                        review!
                      </p>
                    </div>
                    <div className="pt-4">
                      <p className="text-sm text-slate-500">
                        Reviews help travelers make informed decisions and
              ...
              <CardContent>
                <div className="mb-6 p-4 bg-slate-50 rounded-2xl border border-slate-200">
                  <p className="text-xs text-slate-600 leading-relaxed">
                    ⚠️ Use public meeting points for first meetups. No sexual
                    services are allowed on Rainbow Tour Guides.
                  </p>
                </div>
                {!user ? (
                  ...
                  <div className="space-y-4">
                    <p className="text-sm text-slate-600">
                      Sign in to request a booking with{' '}
                      {guideWithRelations.profile.display_name}.
                    </p>
                  ...
                  <BookingForm
                    ...
                    guideName={guideWithRelations.profile.display_name}
                  />
                ) : (
