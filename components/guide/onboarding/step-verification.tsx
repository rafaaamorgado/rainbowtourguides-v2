      ...
      <div className="p-6 border rounded-lg bg-muted/20 space-y-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Securely linked via Stripe Connect.
            </p>
          </div>
        </div>
        ...
        <Alert variant="default" className="bg-blue-50 border-blue-200">
          ...
          <AlertDescription className="text-blue-700">
            After you submit this form, you will be redirected to Stripe to
            verify your identity and link your bank account for payouts.
          </AlertDescription>
        </Alert>
