  ...
  if (!reviews.length) {
    return (
      <section className="space-y-3">
        <h3 className="text-lg font-display font-semibold text-ink">Reviews</h3>
        <div className="rounded-2xl border border-border bg-surface-warm p-6 text-sm text-ink-soft">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-1">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-display font-semibold text-ink">{review.author}</p>
