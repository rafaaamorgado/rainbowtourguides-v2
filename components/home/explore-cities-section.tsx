    ...
    <section className="py-16 lg:py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-3">
          ...
          <h2 className="text-3xl md:text-4xl font-display font-bold text-ink">Plan your next adventure</h2>
        ...
        {!hasCities ? (
          <div className="rounded-2xl border border-dashed border-border bg-surface-warm p-8 text-center space-y-3">
            <h3 className="text-xl font-display font-semibold text-ink">Cities loading soon</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {cities.slice(0, 5).map((city) => (
              <Link
                ...
                className="group relative overflow-hidden rounded-2xl border border-border bg-slate-900 shadow-warm-md transition-transform duration-300 hover:-translate-y-1 aspect-[16/9]"
              >
                ...
                <div className="relative p-6 flex flex-col h-full justify-end space-y-2 text-white">
                  ...
                  <h3 className="text-2xl font-display font-semibold">{city.name}</h3>
            ...
            <Link
              href="/cities"
              className="border border-dashed border-border rounded-2xl flex items-center justify-center text-center p-6 bg-surface-warm hover:bg-card transition-colors"
            >
              <div className="space-y-2">
                <p className="text-sm font-semibold text-brand uppercase tracking-[0.2em]">Browse</p>
                <h3 className="text-xl font-display font-semibold text-ink">View all cities</h3>
