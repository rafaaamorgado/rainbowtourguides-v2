    ...
    <section className="py-16 lg:py-20 bg-background">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-10">
        <div className="space-y-3">
          ...
          <h2 className="text-3xl md:text-4xl font-display font-bold text-ink">Your trip, guided with pride</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={step.title}
                className="h-full rounded-2xl border border-border bg-surface-warm p-6 text-left space-y-4"
              >
                ...
                <h3 className="text-xl font-display font-semibold text-ink">{step.title}</h3>
        ...
        <div className="flex items-center justify-center gap-3">
          <Button asChild className="px-6 h-12 text-base font-semibold rounded-full">
